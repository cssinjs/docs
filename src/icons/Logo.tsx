...
const Logo = ({className, strokeColor, backgroundColor, textColor}: Props) => (
  <Icon>
    {({classes}) => (
      <svg
      ...
      >
        ...
        <path fill={strokeColor} d="M96,107.5H0v-95h96V107.5z M1.803,105.705h92.393v-91.41H1.803C1.803,14.295,1.803,105.705,1.803,105.705z" />
